          ...
          <Col lg={4}>
            <div className="p-3 d-flex flex-column justify-content-between h-100">
              ...
              <Row className="text-center">
                <Col xs={6}>
                  <p className="text-muted mb-2">Эта неделя</p>
                  <h3 className="text-dark mb-3">23.5k</h3>
                </Col>
                <Col xs={6}>
                  <p className="text-muted mb-2">Прошлая неделя</p>
          ...
          <Col lg={8} className="border-start">
            <div className="p-3">
              <div className="d-flex justify-content-between align-items-center">
                <CardTitle as={'h5'}>Производительность</CardTitle>
                <div>
